              ...
              <button
                ...
                className={`flex-1 sm:flex-none px-4 py-1.5 text-xs font-bold rounded-xl transition-all ${
                  activeTab === "directory"
                    ...
                    : "text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-[#303030]"
                }`}
              >
                Directory
              </button>
                          ...
                          <div className="relative pl-6 flex-1 flex flex-col justify-between py-1">
                            ...
                            <div className="relative">
                              <span className={`absolute -left-[23px] top-1.5 h-2.5 w-2.5 rounded-full border-2 border-slate-50 dark:border-[#222226] transition-colors ${
                                todayRec?.punchInTime ? "bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.5)]" : "bg-slate-300 dark:bg-[#3f3f3f]"
                              }`} />
                            ...
                            <div className="relative">
                              <span className={`absolute -left-[17px] top-0.5 h-3 w-3 rounded-full border-2 border-slate-50 dark:border-[#222226] transition-colors ${
                                todayRec?.punchOutTime ? "bg-rose-500 shadow-[0_0_8px_rgba(244,63,94,0.5)]" : "bg-slate-300 dark:bg-[#3f3f3f]"
                              }`} />
                              <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                    ...
                    <CardHeader className="border-b border-slate-100 dark:border-[#303030]">
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div className="flex items-center gap-3">
                          <div className="flex items-center gap-1">
                            <button
                              type="button"
                              onClick={prevMonth}
                              className="h-7 w-7 rounded-xl flex items-center justify-center text-slate-500 hover:text-slate-800 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-[#303030] transition-all cursor-pointer"
                            >
                        ...
                        <div className="flex flex-wrap gap-2 text-[10px] font-bold uppercase tracking-wider">
                          ...
                          <span className="flex items-center gap-1 text-slate-600 dark:text-slate-400"><span className="h-2 w-2 rounded-full bg-slate-400 dark:bg-[#3f3f3f] block shrink-0" /> Off</span>
                        </div>
                      </div>
                    </CardHeader>
                          ...
                          return (
                            ...
                            >
                              ...
                              <span className={cn(
                                ...
                                status === "scheduled" ? "bg-slate-300 dark:bg-[#3f3f3f]" :
                                "bg-slate-200 dark:bg-[#3f3f3f]"
                              )} />
                                      ...
                                      <button
                                        ...
                                        className={`mt-0.5 h-6 w-6 rounded-full border-2 flex items-center justify-center shrink-0 transition-all cursor-pointer ${
                                          t.done === 1
                                            ...
                                            : "border-slate-300 dark:border-[#3f3f3f] bg-transparent text-transparent hover:border-emerald-400"
                                        }`}
                                      >
                        ...
                        <div className="space-y-3">
                          {memberLeaves.map((leave: any) => (
                            ...
                            >
                              ...
                              {leave.reason && (
                                <p className="text-[10px] text-slate-500 italic bg-white dark:bg-[#1f1f1f] p-2.5 rounded-xl border border-slate-100 dark:border-[#303030] leading-relaxed">
                                  {leave.reason}
                                </p>
                              )}
                              {leave.status === "pending" && (
        ...
        <div className="w-full space-y-4">
            ...
            return (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3">
                {employees.map((m) => {
                  ...
                  let dotCls = "bg-slate-300 dark:bg-[#3f3f3f]";
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
            ...
            <Card className="xl:col-span-2 overflow-hidden">
              <CardHeader className="border-b border-slate-100 dark:border-[#303030]">
                <div className="flex items-center gap-2">
                  <button type="button" onClick={prevMonth} className="h-7 w-7 rounded-xl flex items-center justify-center text-slate-500 hover:text-slate-800 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-[#303030] transition-all cursor-pointer">
                    <ChevronLeft className="h-4 w-4" />
                  </button>
                  <button type="button" onClick={nextMonth} className="h-7 w-7 rounded-xl flex items-center justify-center text-slate-500 hover:text-slate-800 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-[#303030] transition-all cursor-pointer">
                    <ChevronRight className="h-4 w-4" />
                  </button>
                ...
                <div className="flex flex-wrap gap-x-3 gap-y-1">
                  {[
                    ...
                    { label: "Off", color: "bg-slate-300 dark:bg-[#3f3f3f]" },
                  ].map(l => (
                            ...
                            <div key={wi} className="grid grid-cols-7 gap-1">
                              {week.map((day, di) => {
                                ...
                                const cellColor =
                                  ...
                                  "bg-slate-200 dark:bg-[#3f3f3f] text-slate-400";
