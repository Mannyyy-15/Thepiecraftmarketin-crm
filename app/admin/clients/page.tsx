                            ...
                            {menuOpenId === c.id && (
                              <div className="absolute right-0 top-8 z-20 w-44 rounded-2xl bg-white dark:bg-[#1f1f1f] border border-slate-200 dark:border-[#303030] shadow-xl p-1.5 space-y-0.5">
                                <button onClick={() => { openEditClient(c); setMenuOpenId(null); }}
                                  className="w-full flex items-center gap-2.5 px-3 py-2 rounded-xl text-xs font-semibold text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-[#303030] transition-all cursor-pointer">
                ...
                <table className="w-full text-xs">
                  ...
                  <tbody className="divide-y divide-slate-100 dark:divide-[#303030]/60">
                    {filteredInvoices.map(inv => {
                      ...
                      return (
                        <tr key={inv.id} className="hover:bg-slate-50 dark:hover:bg-[#303030]/40 transition-colors duration-150">
          ...
          <div className="fixed right-0 top-0 h-full w-full max-w-[540px] bg-white dark:bg-[#1f1f1f] z-50 shadow-2xl flex flex-col animate-[slide-in-right_280ms_cubic-bezier(0.16,1,0.3,1)]">
            ...
            <div className="shrink-0 px-6 pt-5 pb-4 border-b border-slate-200 dark:border-[#303030]">
              <div className="flex items-start justify-between gap-3">
                ...
                <button onClick={() => setDrawerOpen(false)} className="h-8 w-8 rounded-2xl flex items-center justify-center text-slate-400 hover:text-slate-700 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-[#303030] transition-all cursor-pointer">
                  <X className="h-4 w-4" />
                </button>
              </div>
              {/* Step indicator */}
          ...
          <div className="fixed right-0 top-0 h-full w-full max-w-[540px] bg-white dark:bg-[#1f1f1f] z-50 shadow-2xl flex flex-col animate-[slide-in-right_280ms_cubic-bezier(0.16,1,0.3,1)]">
            ...
            <div className="shrink-0 px-6 pt-5 pb-4 border-b border-slate-200 dark:border-[#303030]">
              <div className="flex items-start justify-between gap-3">
                ...
                <button onClick={() => setEditOpen(false)} className="h-8 w-8 rounded-2xl flex items-center justify-center text-slate-400 hover:text-slate-700 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-[#303030] transition-all cursor-pointer">
                  <X className="h-4 w-4" />
                </button>
              </div>
            </div>
          ...
          <div className="fixed right-0 top-0 h-full w-full max-w-[480px] bg-white dark:bg-[#1f1f1f] z-50 shadow-2xl flex flex-col animate-[slide-in-right_280ms_cubic-bezier(0.16,1,0.3,1)]">
            ...
            <div className="shrink-0 px-6 pt-5 pb-4 border-b border-slate-200 dark:border-[#303030]">
              <div className="flex items-start justify-between gap-3">
                ...
                <button onClick={() => setInvDrawer(false)} className="h-8 w-8 rounded-2xl flex items-center justify-center text-slate-400 hover:text-slate-700 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-[#303030] transition-all cursor-pointer">
                  <X className="h-4 w-4" />
                </button>
              </div>
            </div>
          ...
          <div className="flex gap-1 shrink-0 opacity-0 group-hover:opacity-100 transition-opacity">
            {client.stage !== "contract_signed" && (
              <button onClick={() => onMove(client.id, "left")}
                className="h-6 w-6 rounded-xl bg-slate-50 dark:bg-[#303030] border border-slate-200 dark:border-[#38383f] text-slate-400 hover:text-slate-700 dark:hover:text-white flex items-center justify-center cursor-pointer transition-all hover:bg-slate-100 dark:hover:bg-[#3f3f3f]"
