...
import {
  ...
  Target, ExternalLink, Globe, CheckCircle2, Plus,
} from "lucide-react";
...
import { getProjects, getProjectTasksGrouped, toggleTaskStatus, getFreshUserProfile } from "@/app/actions/crm";
...
export default function EmployeeProjectsPage() {
  ...
  const load = async () => {
    ...
    try {
      const [pr, tk, pf] = await Promise.all([getProjects(), getProjectTasksGrouped(), getFreshUserProfile()]);
    ...
    <div className="space-y-6">
      <PageHeader
        ...
        actions={canManageProjects ? (
          <Button size="sm" onClick={() => setAddOpen(true)} className="bg-brand-600 text-white">
