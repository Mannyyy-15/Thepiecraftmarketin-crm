            ...
            {showNotifications && (
              <div className="absolute right-0 mt-2.5 w-80 sm:w-96 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-xl z-50 overflow-hidden animate-fadeIn">
                <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800/80 px-4 py-3">
                  <div>
                    <p className="text-[10px] font-extrabold uppercase tracking-widest text-slate-400">Inbox</p>
                    ...
                    return (
                      <div
                        ...
                        className={`flex items-start gap-3 p-3.5 transition-colors cursor-pointer ${
                          n.read ? "hover:bg-slate-50/60 dark:hover:bg-slate-900/30" : "bg-indigo-500/5 hover:bg-indigo-500/10"
                        }`}
                      >
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="flex items-center justify-between gap-2">
                            ...
                            <span className="text-[9px] text-slate-400 font-medium tabular-nums shrink-0">{n._time}</span>
                          </div>
